...
//  source: /Users/marcussmith/Laundryman/Libraries/libphonenumber/java/internal/prefixmapper/src/main/java/com/google/i18n/phonenumbers/prefixmapper/PhonePrefixMap.java
//
...
- (void)readExternalWithJavaIoObjectInput:(id<JavaIoObjectInput>)objectInput {
  ...
  if (useFlyweightMapStorage) {
    JreStrongAssignAndConsume(&phonePrefixMapStorage_, new_ComGoogleI18nPhonenumbersPrefixmapperFlyweightMapStorage_initPackagePrivate());
  }
  else {
    JreStrongAssignAndConsume(&phonePrefixMapStorage_, new_ComGoogleI18nPhonenumbersPrefixmapperDefaultMapStorage_initPackagePrivate());
  }
...
ComGoogleI18nPhonenumbersPrefixmapperPhonePrefixMapStorageStrategy *ComGoogleI18nPhonenumbersPrefixmapperPhonePrefixMap_createDefaultMapStorage(ComGoogleI18nPhonenumbersPrefixmapperPhonePrefixMap *self) {
  return create_ComGoogleI18nPhonenumbersPrefixmapperDefaultMapStorage_initPackagePrivate();
}
...
ComGoogleI18nPhonenumbersPrefixmapperPhonePrefixMapStorageStrategy *ComGoogleI18nPhonenumbersPrefixmapperPhonePrefixMap_createFlyweightMapStorage(ComGoogleI18nPhonenumbersPrefixmapperPhonePrefixMap *self) {
  return create_ComGoogleI18nPhonenumbersPrefixmapperFlyweightMapStorage_initPackagePrivate();
}
