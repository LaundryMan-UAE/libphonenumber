...
- (instancetype)initPackagePrivate {
  ComGoogleI18nPhonenumbersPrefixmapperDefaultMapStorage_initPackagePrivate(self);
  return self;
}
...
void ComGoogleI18nPhonenumbersPrefixmapperDefaultMapStorage_initPackagePrivate(ComGoogleI18nPhonenumbersPrefixmapperDefaultMapStorage *self) {
  ComGoogleI18nPhonenumbersPrefixmapperPhonePrefixMapStorageStrategy_initPackagePrivate(self);
}

ComGoogleI18nPhonenumbersPrefixmapperDefaultMapStorage *new_ComGoogleI18nPhonenumbersPrefixmapperDefaultMapStorage_initPackagePrivate() {
  J2OBJC_NEW_IMPL(ComGoogleI18nPhonenumbersPrefixmapperDefaultMapStorage, initPackagePrivate)
}

ComGoogleI18nPhonenumbersPrefixmapperDefaultMapStorage *create_ComGoogleI18nPhonenumbersPrefixmapperDefaultMapStorage_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(ComGoogleI18nPhonenumbersPrefixmapperDefaultMapStorage, initPackagePrivate)
}
