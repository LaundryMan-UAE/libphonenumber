...
- (void)clear {
  ...
  if (![((ComGoogleI18nPhonenumbersPhonemetadata_PhoneMetadata *) nil_chk(currentMetadata_)) isEqual:defaultMetadata_]) {
    currentMetadata_ = ComGoogleI18nPhonenumbersAsYouTypeFormatter_getMetadataForRegionWithNSString_(self, defaultCountry_);
  }
}

- (NSString *)inputDigitWithChar:(jchar)nextChar {
  currentOutput_ = ComGoogleI18nPhonenumbersAsYouTypeFormatter_inputDigitWithOptionToRememberPositionWithChar_withBoolean_(self, nextChar, false);
  return currentOutput_;
}

- (NSString *)inputDigitAndRememberPositionWithChar:(jchar)nextChar {
  currentOutput_ = ComGoogleI18nPhonenumbersAsYouTypeFormatter_inputDigitWithOptionToRememberPositionWithChar_withBoolean_(self, nextChar, true);
  return currentOutput_;
}
...
+ (void)initialize {
  if (self == [ComGoogleI18nPhonenumbersAsYouTypeFormatter class]) {
    ComGoogleI18nPhonenumbersAsYouTypeFormatter_EMPTY_METADATA = [new_ComGoogleI18nPhonenumbersPhonemetadata_PhoneMetadata_init() setInternationalPrefixWithNSString:@"NA"];
    ComGoogleI18nPhonenumbersAsYouTypeFormatter_CHARACTER_CLASS_PATTERN = JavaUtilRegexPattern_compileWithNSString_(@"\\[([^\\[\\]])*\\]");
    ComGoogleI18nPhonenumbersAsYouTypeFormatter_STANDALONE_DIGIT_PATTERN = JavaUtilRegexPattern_compileWithNSString_(@"\\d(?=[^,}][^,}])");
    ComGoogleI18nPhonenumbersAsYouTypeFormatter_ELIGIBLE_FORMAT_PATTERN = JavaUtilRegexPattern_compileWithNSString_(JreStrcat("C$$$$", '[', ComGoogleI18nPhonenumbersPhoneNumberUtil_VALID_PUNCTUATION, @"]*(\\$\\d[", ComGoogleI18nPhonenumbersPhoneNumberUtil_VALID_PUNCTUATION, @"]*)+"));
    ComGoogleI18nPhonenumbersAsYouTypeFormatter_NATIONAL_PREFIX_SEPARATORS_PATTERN = JavaUtilRegexPattern_compileWithNSString_(@"[- ]");
    ComGoogleI18nPhonenumbersAsYouTypeFormatter_DIGIT_PATTERN = JavaUtilRegexPattern_compileWithNSString_(ComGoogleI18nPhonenumbersAsYouTypeFormatter_DIGIT_PLACEHOLDER);
...
void ComGoogleI18nPhonenumbersAsYouTypeFormatter_initWithNSString_(ComGoogleI18nPhonenumbersAsYouTypeFormatter *self, NSString *regionCode) {
  NSObject_init(self);
  self->currentOutput_ = @"";
  self->formattingTemplate_ = new_JavaLangStringBuilder_init();
  self->currentFormattingPattern_ = @"";
  self->accruedInput_ = new_JavaLangStringBuilder_init();
  self->accruedInputWithoutFormatting_ = new_JavaLangStringBuilder_init();
  ...
  self->phoneUtil_ = ComGoogleI18nPhonenumbersPhoneNumberUtil_getInstance();
  self->lastMatchPosition_ = 0;
  self->originalPosition_ = 0;
  self->positionToRemember_ = 0;
  self->prefixBeforeNationalNumber_ = new_JavaLangStringBuilder_init();
  self->shouldAddSpaceAfterNationalPrefix_ = false;
  self->extractedNationalPrefix_ = @"";
  self->nationalNumber_ = new_JavaLangStringBuilder_init();
  self->possibleFormats_ = new_JavaUtilArrayList_init();
  self->regexCache_ = new_ComGoogleI18nPhonenumbersInternalRegexCache_initWithInt_(64);
  self->defaultCountry_ = regionCode;
  self->currentMetadata_ = ComGoogleI18nPhonenumbersAsYouTypeFormatter_getMetadataForRegionWithNSString_(self, self->defaultCountry_);
...
jboolean ComGoogleI18nPhonenumbersAsYouTypeFormatter_createFormattingTemplateWithComGoogleI18nPhonenumbersPhonemetadata_NumberFormat_(ComGoogleI18nPhonenumbersAsYouTypeFormatter *self, ComGoogleI18nPhonenumbersPhonemetadata_NumberFormat *format) {
  ...
  if ([((NSString *) nil_chk(tempTemplate)) java_length] > 0) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->formattingTemplate_)) appendWithNSString:tempTemplate];
    return true;
  }
  return false;
}
...
NSString *ComGoogleI18nPhonenumbersAsYouTypeFormatter_inputDigitWithOptionToRememberPositionWithChar_withBoolean_(ComGoogleI18nPhonenumbersAsYouTypeFormatter *self, jchar nextChar, jboolean rememberPosition) {
  (void) [((JavaLangStringBuilder *) nil_chk(self->accruedInput_)) appendWithChar:nextChar];
  if (rememberPosition) {
  ...
  if (!self->ableToFormat_) {
    if (self->inputHasFormatting_) {
      ...
      (void) [((JavaLangStringBuilder *) nil_chk(self->prefixBeforeNationalNumber_)) appendWithChar:ComGoogleI18nPhonenumbersAsYouTypeFormatter_SEPARATOR_BEFORE_NATIONAL_NUMBER];
      return ComGoogleI18nPhonenumbersAsYouTypeFormatter_attemptToChoosePatternWithPrefixExtracted(self);
    }
    return [((JavaLangStringBuilder *) nil_chk(self->accruedInput_)) description];
  }
  switch ([((JavaLangStringBuilder *) nil_chk(self->accruedInputWithoutFormatting_)) java_length]) {
    ...
    if (ComGoogleI18nPhonenumbersAsYouTypeFormatter_attemptToExtractIdd(self)) {
      ...
      self->extractedNationalPrefix_ = ComGoogleI18nPhonenumbersAsYouTypeFormatter_removeNationalPrefixFromNationalNumber(self);
...
jboolean ComGoogleI18nPhonenumbersAsYouTypeFormatter_ableToExtractLongerNdd(ComGoogleI18nPhonenumbersAsYouTypeFormatter *self) {
  if ([((NSString *) nil_chk(self->extractedNationalPrefix_)) java_length] > 0) {
    (void) [((JavaLangStringBuilder *) nil_chk(self->nationalNumber_)) insertWithInt:0 withNSString:self->extractedNationalPrefix_];
...
NSString *ComGoogleI18nPhonenumbersAsYouTypeFormatter_removeNationalPrefixFromNationalNumber(ComGoogleI18nPhonenumbersAsYouTypeFormatter *self) {
  ...
  if (ComGoogleI18nPhonenumbersAsYouTypeFormatter_isNanpaNumberWithNationalPrefix(self)) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(self->prefixBeforeNationalNumber_)) appendWithChar:'1'])) appendWithChar:ComGoogleI18nPhonenumbersAsYouTypeFormatter_SEPARATOR_BEFORE_NATIONAL_NUMBER];
    ...
    if ([((JavaUtilRegexMatcher *) nil_chk(m)) lookingAt] && [m end] > 0) {
      ...
      (void) [((JavaLangStringBuilder *) nil_chk(self->prefixBeforeNationalNumber_)) appendWithNSString:[((JavaLangStringBuilder *) nil_chk(self->nationalNumber_)) substringWithInt:0 withInt:startOfNationalNumber]];
    }
  }
  ...
  (void) [((JavaLangStringBuilder *) nil_chk(self->nationalNumber_)) delete__WithInt:0 withInt:startOfNationalNumber];
...
jboolean ComGoogleI18nPhonenumbersAsYouTypeFormatter_attemptToExtractIdd(ComGoogleI18nPhonenumbersAsYouTypeFormatter *self) {
  ...
  if ([((JavaUtilRegexMatcher *) nil_chk(iddMatcher)) lookingAt]) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(self->nationalNumber_)) appendWithNSString:[((JavaLangStringBuilder *) nil_chk(self->accruedInputWithoutFormatting_)) substringWithInt:startOfCountryCallingCode]];
    [((JavaLangStringBuilder *) nil_chk(self->prefixBeforeNationalNumber_)) setLengthWithInt:0];
    (void) [((JavaLangStringBuilder *) nil_chk(self->prefixBeforeNationalNumber_)) appendWithNSString:[((JavaLangStringBuilder *) nil_chk(self->accruedInputWithoutFormatting_)) substringWithInt:0 withInt:startOfCountryCallingCode]];
...
jboolean ComGoogleI18nPhonenumbersAsYouTypeFormatter_attemptToExtractCountryCallingCode(ComGoogleI18nPhonenumbersAsYouTypeFormatter *self) {
  ...
  JavaLangStringBuilder *numberWithoutCountryCallingCode = new_JavaLangStringBuilder_init();
  ...
  [((JavaLangStringBuilder *) nil_chk(self->nationalNumber_)) setLengthWithInt:0];
  (void) [((JavaLangStringBuilder *) nil_chk(self->nationalNumber_)) appendWithJavaLangCharSequence:numberWithoutCountryCallingCode];
  ...
  if ([((NSString *) nil_chk(ComGoogleI18nPhonenumbersPhoneNumberUtil_REGION_CODE_FOR_NON_GEO_ENTITY)) isEqual:newRegionCode]) {
    self->currentMetadata_ = [self->phoneUtil_ getMetadataForNonGeographicalRegionWithInt:countryCode];
  }
  else if (![((NSString *) nil_chk(newRegionCode)) isEqual:self->defaultCountry_]) {
    self->currentMetadata_ = ComGoogleI18nPhonenumbersAsYouTypeFormatter_getMetadataForRegionWithNSString_(self, newRegionCode);
  }
  NSString *countryCodeString = JavaLangInteger_toStringWithInt_(countryCode);
  (void) [((JavaLangStringBuilder *) nil_chk([((JavaLangStringBuilder *) nil_chk(self->prefixBeforeNationalNumber_)) appendWithNSString:countryCodeString])) appendWithChar:ComGoogleI18nPhonenumbersAsYouTypeFormatter_SEPARATOR_BEFORE_NATIONAL_NUMBER];
  self->extractedNationalPrefix_ = @"";
  return true;
}
...
jchar ComGoogleI18nPhonenumbersAsYouTypeFormatter_normalizeAndAccrueDigitsAndPlusSignWithChar_withBoolean_(ComGoogleI18nPhonenumbersAsYouTypeFormatter *self, jchar nextChar, jboolean rememberPosition) {
  ...
  if (nextChar == ComGoogleI18nPhonenumbersPhoneNumberUtil_PLUS_SIGN) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(self->accruedInputWithoutFormatting_)) appendWithChar:nextChar];
  }
  else {
    jint radix = 10;
    normalizedChar = JavaLangCharacter_forDigitWithInt_withInt_(JavaLangCharacter_digitWithChar_withInt_(nextChar, radix), radix);
    (void) [((JavaLangStringBuilder *) nil_chk(self->accruedInputWithoutFormatting_)) appendWithChar:normalizedChar];
    (void) [((JavaLangStringBuilder *) nil_chk(self->nationalNumber_)) appendWithChar:normalizedChar];
  }
  if (rememberPosition) {
...
NSString *ComGoogleI18nPhonenumbersAsYouTypeFormatter_inputDigitHelperWithChar_(ComGoogleI18nPhonenumbersAsYouTypeFormatter *self, jchar nextChar) {
  ...
  if ([((JavaUtilRegexMatcher *) nil_chk(digitMatcher)) findWithInt:self->lastMatchPosition_]) {
    ...
    (void) [((JavaLangStringBuilder *) nil_chk(self->formattingTemplate_)) replaceWithInt:0 withInt:[((NSString *) nil_chk(tempTemplate)) java_length] withNSString:tempTemplate];
