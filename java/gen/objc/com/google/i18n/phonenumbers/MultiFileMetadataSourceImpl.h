...
- (instancetype __nonnull)initPackagePrivateWithNSString:(NSString *)phoneNumberMetadataFilePrefix
...
FOUNDATION_EXPORT void ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl_initPackagePrivateWithNSString_withComGoogleI18nPhonenumbersMetadataLoader_(ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl *self, NSString *phoneNumberMetadataFilePrefix, id<ComGoogleI18nPhonenumbersMetadataLoader> metadataLoader);

FOUNDATION_EXPORT ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl *new_ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl_initPackagePrivateWithNSString_withComGoogleI18nPhonenumbersMetadataLoader_(NSString *phoneNumberMetadataFilePrefix, id<ComGoogleI18nPhonenumbersMetadataLoader> metadataLoader) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl *create_ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl_initPackagePrivateWithNSString_withComGoogleI18nPhonenumbersMetadataLoader_(NSString *phoneNumberMetadataFilePrefix, id<ComGoogleI18nPhonenumbersMetadataLoader> metadataLoader);

FOUNDATION_EXPORT void ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl_initPackagePrivateWithComGoogleI18nPhonenumbersMetadataLoader_(ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl *self, id<ComGoogleI18nPhonenumbersMetadataLoader> metadataLoader);

FOUNDATION_EXPORT ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl *new_ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl_initPackagePrivateWithComGoogleI18nPhonenumbersMetadataLoader_(id<ComGoogleI18nPhonenumbersMetadataLoader> metadataLoader) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl *create_ComGoogleI18nPhonenumbersMultiFileMetadataSourceImpl_initPackagePrivateWithComGoogleI18nPhonenumbersMetadataLoader_(id<ComGoogleI18nPhonenumbersMetadataLoader> metadataLoader);
