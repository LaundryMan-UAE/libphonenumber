...
/*!
 ...
 @return the match found, null if none can be found
 */
- (ComGoogleI18nPhonenumbersPhoneNumberMatch *)extractInnerMatchWithJavaLangCharSequence:(id<JavaLangCharSequence>)candidate
                                                                                 withInt:(jint)offset;
 ...
 */
- (ComGoogleI18nPhonenumbersPhoneNumberMatch *)parseAndVerifyWithJavaLangCharSequence:(id<JavaLangCharSequence>)candidate
                                                                              withInt:(jint)offset;
...
- (ComGoogleI18nPhonenumbersPhoneNumberMatch *)parseAndVerifyWithJavaLangCharSequence:(id<JavaLangCharSequence>)candidate
                                                                              withInt:(jint)offset {
  return ComGoogleI18nPhonenumbersPhoneNumberMatcher_parseAndVerifyWithJavaLangCharSequence_withInt_(self, candidate, offset);
}
...
+ (IOSObjectArray *)getNationalNumberGroupsWithComGoogleI18nPhonenumbersPhoneNumberUtil:(ComGoogleI18nPhonenumbersPhoneNumberUtil *)util
                                   withComGoogleI18nPhonenumbersPhonenumber_PhoneNumber:(ComGoogleI18nPhonenumbersPhonenumber_PhoneNumber *)number
                                withComGoogleI18nPhonenumbersPhonemetadata_NumberFormat:(ComGoogleI18nPhonenumbersPhonemetadata_NumberFormat *)formattingPattern {
  return ComGoogleI18nPhonenumbersPhoneNumberMatcher_getNationalNumberGroupsWithComGoogleI18nPhonenumbersPhoneNumberUtil_withComGoogleI18nPhonenumbersPhonenumber_PhoneNumber_withComGoogleI18nPhonenumbersPhonemetadata_NumberFormat_(util, number, formattingPattern);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LComGoogleI18nPhonenumbersPhoneNumberMatch;", 0x2, 12, 11, -1, -1, -1, -1 },
    { NULL, "LComGoogleI18nPhonenumbersPhoneNumberMatch;", 0x2, 13, 11, -1, -1, -1, -1 },
    ...
    { NULL, "Z", 0x8, 23, 24, -1, -1, -1, -1 },
    { NULL, "Z", 0x8, 25, 26, -1, -1, -1, -1 },
  ...
  methods[7].selector = @selector(extractInnerMatchWithJavaLangCharSequence:withInt:);
  methods[8].selector = @selector(parseAndVerifyWithJavaLangCharSequence:withInt:);
  ...
  methods[11].selector = @selector(getNationalNumberGroupsWithComGoogleI18nPhonenumbersPhoneNumberUtil:withComGoogleI18nPhonenumbersPhonenumber_PhoneNumber:withComGoogleI18nPhonenumbersPhonemetadata_NumberFormat:);
  methods[12].selector = @selector(checkNumberGroupingIsValidWithComGoogleI18nPhonenumbersPhonenumber_PhoneNumber:withJavaLangCharSequence:withComGoogleI18nPhonenumbersPhoneNumberUtil:withComGoogleI18nPhonenumbersPhoneNumberMatcher_NumberGroupingChecker:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "PATTERN", "LJavaUtilRegexPattern;", .constantValue.asLong = 0, 0x1a, -1, 27, -1, -1 },
    { "PUB_PAGES", "LJavaUtilRegexPattern;", .constantValue.asLong = 0, 0x1a, -1, 28, -1, -1 },
    { "SLASH_SEPARATED_DATES", "LJavaUtilRegexPattern;", .constantValue.asLong = 0, 0x1a, -1, 29, -1, -1 },
    { "TIME_STAMPS", "LJavaUtilRegexPattern;", .constantValue.asLong = 0, 0x1a, -1, 30, -1, -1 },
    { "TIME_STAMPS_SUFFIX", "LJavaUtilRegexPattern;", .constantValue.asLong = 0, 0x1a, -1, 31, -1, -1 },
    { "MATCHING_BRACKETS", "LJavaUtilRegexPattern;", .constantValue.asLong = 0, 0x1a, -1, 32, -1, -1 },
    { "INNER_MATCHES", "[LJavaUtilRegexPattern;", .constantValue.asLong = 0, 0x1a, -1, 33, -1, -1 },
    { "LEAD_CLASS", "LJavaUtilRegexPattern;", .constantValue.asLong = 0, 0x1a, -1, 34, -1, -1 },
...
ComGoogleI18nPhonenumbersPhoneNumberMatch *ComGoogleI18nPhonenumbersPhoneNumberMatcher_parseAndVerifyWithJavaLangCharSequence_withInt_(ComGoogleI18nPhonenumbersPhoneNumberMatcher *self, id<JavaLangCharSequence> candidate, jint offset) {
  @try {
    ...
    if ([((ComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency *) nil_chk(self->leniency_)) compareToWithId:JreLoadEnum(ComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency, VALID)] >= 0) {
      ...
      jint lastCharIndex = offset + [((id<JavaLangCharSequence>) nil_chk(candidate)) length];
...
jboolean ComGoogleI18nPhonenumbersPhoneNumberMatcher_containsMoreThanOneSlashInNationalNumberWithComGoogleI18nPhonenumbersPhonenumber_PhoneNumber_withNSString_(ComGoogleI18nPhonenumbersPhonenumber_PhoneNumber *number, NSString *candidate) {
  ...
  if (candidateHasCountryCode && [((NSString *) nil_chk(ComGoogleI18nPhonenumbersPhoneNumberUtil_normalizeDigitsOnlyWithJavaLangCharSequence_([candidate substring:0 endIndex:firstSlashInBodyIndex]))) isEqual:JavaLangInteger_toStringWithInt_([number getCountryCode])]) {
  ...
  for (jint index = 0; index < ((jint) [((NSString *) nil_chk(candidate)) length]) - 1; index++) {
    ...
    if (charAtIndex == 'x' || charAtIndex == 'X') {
      ...
      if (charAtNextIndex == 'x' || charAtNextIndex == 'X') {
        index++;
        if ([((ComGoogleI18nPhonenumbersPhoneNumberUtil *) nil_chk(util)) isNumberMatchWithComGoogleI18nPhonenumbersPhonenumber_PhoneNumber:number withJavaLangCharSequence:[candidate substring:index]] != JreLoadEnum(ComGoogleI18nPhonenumbersPhoneNumberUtil_MatchType, NSN_MATCH)) {
          return false;
        }
      }
      else if (![((NSString *) nil_chk(ComGoogleI18nPhonenumbersPhoneNumberUtil_normalizeDigitsOnlyWithJavaLangCharSequence_([candidate substring:index]))) isEqual:[((ComGoogleI18nPhonenumbersPhonenumber_PhoneNumber *) nil_chk(number)) getExtension]]) {
        return false;
      }
    }
  }
...
jboolean ComGoogleI18nPhonenumbersPhoneNumberMatcher_isNationalPrefixPresentIfRequiredWithComGoogleI18nPhonenumbersPhonenumber_PhoneNumber_withComGoogleI18nPhonenumbersPhoneNumberUtil_(ComGoogleI18nPhonenumbersPhonenumber_PhoneNumber *number, ComGoogleI18nPhonenumbersPhoneNumberUtil *util) {
  ...
  if ((formatRule != nil) && ((jint) [((NSString *) nil_chk([((ComGoogleI18nPhonenumbersPhonemetadata_NumberFormat *) nil_chk(formatRule)) getNationalPrefixFormattingRule])) length]) > 0) {
