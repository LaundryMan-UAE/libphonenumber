...
//  source: /Users/marcussmith/Laundryman/Libraries/libphonenumber/java/libphonenumber/src/main/java/com/google/i18n/phonenumbers/PhoneNumberMatcher.java
//
...
- (ComGoogleI18nPhonenumbersPhoneNumberMatcher_State_Enum)toNSEnum;
...
- (instancetype)initPackagePrivateWithComGoogleI18nPhonenumbersPhoneNumberUtil:(ComGoogleI18nPhonenumbersPhoneNumberUtil *)util
  ...
  ComGoogleI18nPhonenumbersPhoneNumberMatcher_initPackagePrivateWithComGoogleI18nPhonenumbersPhoneNumberUtil_withJavaLangCharSequence_withNSString_withComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency_withLong_(self, util, text, country, leniency, maxTries);
  return self;
}
...
void ComGoogleI18nPhonenumbersPhoneNumberMatcher_initPackagePrivateWithComGoogleI18nPhonenumbersPhoneNumberUtil_withJavaLangCharSequence_withNSString_withComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency_withLong_(ComGoogleI18nPhonenumbersPhoneNumberMatcher *self, ComGoogleI18nPhonenumbersPhoneNumberUtil *util, id<JavaLangCharSequence> text, NSString *country, ComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency *leniency, jlong maxTries) {
  NSObject_init(self);
...
ComGoogleI18nPhonenumbersPhoneNumberMatcher *new_ComGoogleI18nPhonenumbersPhoneNumberMatcher_initPackagePrivateWithComGoogleI18nPhonenumbersPhoneNumberUtil_withJavaLangCharSequence_withNSString_withComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency_withLong_(ComGoogleI18nPhonenumbersPhoneNumberUtil *util, id<JavaLangCharSequence> text, NSString *country, ComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency *leniency, jlong maxTries) {
  J2OBJC_NEW_IMPL(ComGoogleI18nPhonenumbersPhoneNumberMatcher, initPackagePrivateWithComGoogleI18nPhonenumbersPhoneNumberUtil_withJavaLangCharSequence_withNSString_withComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency_withLong_, util, text, country, leniency, maxTries)
}

ComGoogleI18nPhonenumbersPhoneNumberMatcher *create_ComGoogleI18nPhonenumbersPhoneNumberMatcher_initPackagePrivateWithComGoogleI18nPhonenumbersPhoneNumberUtil_withJavaLangCharSequence_withNSString_withComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency_withLong_(ComGoogleI18nPhonenumbersPhoneNumberUtil *util, id<JavaLangCharSequence> text, NSString *country, ComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency *leniency, jlong maxTries) {
  J2OBJC_CREATE_IMPL(ComGoogleI18nPhonenumbersPhoneNumberMatcher, initPackagePrivateWithComGoogleI18nPhonenumbersPhoneNumberUtil_withJavaLangCharSequence_withNSString_withComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency_withLong_, util, text, country, leniency, maxTries)
}
...
- (ComGoogleI18nPhonenumbersPhoneNumberMatcher_State_Enum)toNSEnum {
  return (ComGoogleI18nPhonenumbersPhoneNumberMatcher_State_Enum)[self ordinal];
}
