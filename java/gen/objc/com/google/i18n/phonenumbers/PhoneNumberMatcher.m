...
//  source: /Users/marcussmith/temp/libphonenumber/java/libphonenumber/src/main/java/com/google/i18n/phonenumbers/PhoneNumberMatcher.java
//
...
- (jboolean)hasNext {
  if (state_ == JreLoadEnum(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State, NOT_READY)) {
    lastMatch_ = ComGoogleI18nPhonenumbersPhoneNumberMatcher_findWithInt_(self, searchIndex_);
    if (lastMatch_ == nil) {
      state_ = JreLoadEnum(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State, DONE);
    }
    else {
      searchIndex_ = [lastMatch_ end];
      state_ = JreLoadEnum(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State, READY);
    }
  }
...
- (ComGoogleI18nPhonenumbersPhoneNumberMatch *)next {
  ...
  lastMatch_ = nil;
  state_ = JreLoadEnum(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State, NOT_READY);
  return result;
}
...
+ (void)initialize {
  if (self == [ComGoogleI18nPhonenumbersPhoneNumberMatcher class]) {
    ComGoogleI18nPhonenumbersPhoneNumberMatcher_PUB_PAGES = JavaUtilRegexPattern_compileWithNSString_(@"\\d{1,5}-+\\d{1,5}\\s{0,4}\\(\\d{1,4}");
    ComGoogleI18nPhonenumbersPhoneNumberMatcher_SLASH_SEPARATED_DATES = JavaUtilRegexPattern_compileWithNSString_(@"(?:(?:[0-3]?\\d/[01]?\\d)|(?:[01]?\\d/[0-3]?\\d))/(?:[12]\\d)?\\d{2}");
    ComGoogleI18nPhonenumbersPhoneNumberMatcher_TIME_STAMPS = JavaUtilRegexPattern_compileWithNSString_(@"[12]\\d{3}[-/]?[01]\\d[-/]?[0-3]\\d +[0-2]\\d$");
    ComGoogleI18nPhonenumbersPhoneNumberMatcher_TIME_STAMPS_SUFFIX = JavaUtilRegexPattern_compileWithNSString_(@":[0-5]\\d");
    ComGoogleI18nPhonenumbersPhoneNumberMatcher_INNER_MATCHES = [IOSObjectArray newArrayWithObjects:(id[]){ JavaUtilRegexPattern_compileWithNSString_(@"/+(.*)"), JavaUtilRegexPattern_compileWithNSString_(@"(\\([^(]*)"), JavaUtilRegexPattern_compileWithNSString_(@"(?:\\p{Z}-|-\\p{Z})\\p{Z}*(.+)"), JavaUtilRegexPattern_compileWithNSString_(@"[\u2012-\u2015\uff0d]\\p{Z}*(.+)"), JavaUtilRegexPattern_compileWithNSString_(@"\\.+\\p{Z}*([^.]+)"), JavaUtilRegexPattern_compileWithNSString_(@"\\p{Z}+(\\P{Z}+)") } count:6 type:JavaUtilRegexPattern_class_()];
    {
      ...
      ComGoogleI18nPhonenumbersPhoneNumberMatcher_MATCHING_BRACKETS = JavaUtilRegexPattern_compileWithNSString_(JreStrcat("$$$$$$$$$$C$$$$$$C", @"(?:[", openingParens, @"])?(?:", nonParens, @"+[", closingParens, @"])?", nonParens, @"+(?:[", openingParens, ']', nonParens, @"+[", closingParens, @"])", bracketPairLimit, nonParens, '*'));
...
void ComGoogleI18nPhonenumbersPhoneNumberMatcher_initWithComGoogleI18nPhonenumbersPhoneNumberUtil_withJavaLangCharSequence_withNSString_withComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency_withLong_(ComGoogleI18nPhonenumbersPhoneNumberMatcher *self, ComGoogleI18nPhonenumbersPhoneNumberUtil *util, id<JavaLangCharSequence> text, NSString *country, ComGoogleI18nPhonenumbersPhoneNumberUtil_Leniency *leniency, jlong maxTries) {
  NSObject_init(self);
  self->state_ = JreLoadEnum(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State, NOT_READY);
  self->lastMatch_ = nil;
  self->searchIndex_ = 0;
  ...
  self->phoneUtil_ = util;
  self->text_ = (text != nil) ? text : (id) @"";
  self->preferredRegion_ = country;
  self->leniency_ = leniency;
...
ComGoogleI18nPhonenumbersPhoneNumberMatch *ComGoogleI18nPhonenumbersPhoneNumberMatcher_parseAndVerifyWithJavaLangCharSequence_withInt_(ComGoogleI18nPhonenumbersPhoneNumberMatcher *self, id<JavaLangCharSequence> candidate, jint offset) {
  @try {
    ...
    if ([self->leniency_ verifyWithComGoogleI18nPhonenumbersPhonenumber_PhoneNumber:number withJavaLangCharSequence:candidate withComGoogleI18nPhonenumbersPhoneNumberUtil:self->phoneUtil_]) {
      (void) [number clearCountryCodeSource];
      (void) [number clearRawInput];
      (void) [number clearPreferredDomesticCarrierCode];
      return new_ComGoogleI18nPhonenumbersPhoneNumberMatch_initWithInt_withNSString_withComGoogleI18nPhonenumbersPhonenumber_PhoneNumber_(offset, [((id<JavaLangCharSequence>) nil_chk(candidate)) description], number);
    }
  }
...
jboolean ComGoogleI18nPhonenumbersPhoneNumberMatcher_isNationalPrefixPresentIfRequiredWithComGoogleI18nPhonenumbersPhonenumber_PhoneNumber_withComGoogleI18nPhonenumbersPhoneNumberUtil_(ComGoogleI18nPhonenumbersPhonenumber_PhoneNumber *number, ComGoogleI18nPhonenumbersPhoneNumberUtil *util) {
  ...
  if ((formatRule != nil) && [((NSString *) nil_chk([((ComGoogleI18nPhonenumbersPhonemetadata_NumberFormat *) nil_chk(formatRule)) getNationalPrefixFormattingRule])) java_length] > 0) {
    ...
    JavaLangStringBuilder *rawInput = new_JavaLangStringBuilder_initWithNSString_(rawInputCopy);
...
+ (void)initialize {
  if (self == [ComGoogleI18nPhonenumbersPhoneNumberMatcher_State class]) {
    JreEnum(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State, NOT_READY) = new_ComGoogleI18nPhonenumbersPhoneNumberMatcher_State_initWithNSString_withInt_(JreEnumConstantName(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State_class_(), 0), 0);
    JreEnum(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State, READY) = new_ComGoogleI18nPhonenumbersPhoneNumberMatcher_State_initWithNSString_withInt_(JreEnumConstantName(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State_class_(), 1), 1);
    JreEnum(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State, DONE) = new_ComGoogleI18nPhonenumbersPhoneNumberMatcher_State_initWithNSString_withInt_(JreEnumConstantName(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State_class_(), 2), 2);
...
ComGoogleI18nPhonenumbersPhoneNumberMatcher_State *new_ComGoogleI18nPhonenumbersPhoneNumberMatcher_State_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(ComGoogleI18nPhonenumbersPhoneNumberMatcher_State, initWithNSString_withInt_, __name, __ordinal)
}
